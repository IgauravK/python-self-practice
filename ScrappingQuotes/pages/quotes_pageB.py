from locators.quotes_page_locatorsB import QuotesPageLocators
from parsers.quoteB import QuoteParser
...
class QuotesPage:
    ...
    def get_available_tag(self) -> List[str]:
    ...
    def search_for_quotes(self, author_name: str, tag_name: str) -> List[QuoteParser]:
        ...
        try:
            ...
            raise InvalidTagForAuthorError(
                f"Author '{author_name}' does not have any uote tagged in '{tag_name}'."
            )
